...
export default function AdPlaceholder({ slotId, format = 'auto', type = 'banner' }) {
  ...
  if (!clientId) {
    return (
      <div className={`my-6 mx-auto flex items-center justify-center border-2 border-dashed border-slate-300 bg-slate-50 text-slate-400 rounded-xl select-none p-4 max-w-full ${heightClasses}`}>
  ...
  return (
    <div className="my-6 mx-auto flex justify-center overflow-hidden max-w-full">
      <ins
