...
export default function ExamSecretsPage() {
  ...
  const examSecretsData = [
    ...
    },
    {
      ...
      traps: [
        {
          title: "මුක්ත වස්තු සටහන් (Free Body Diagrams) උගුල:",
    ...
    },
    {
      ...
      traps: [
        {
          title: "නිෂ්පන්ද (N) සහ ප්‍රස්පන්ද (AN) ලකුණු කිරීම:",
          description: "අනුනාද නළ පාඩමේ ව්‍යුහගත ප්‍රශ්න වලදී නළය ඇතුළේ තරංග හැඩය අඳින විට විවෘත කෙළවර ප්‍රස්පන්දයක් (AN) ලෙසත්, වැසුණු කෙළවර නිෂ්පන්දයක් (N) ලෙසත් පැහැදිලිව අකුරින්ම ලකුණු කළ යුතුය."
        }
      ]
    },
    {
    ...
    },
    {
      ...
      traps: [
        ...
        {
          title: "පොයිසල් සමීකරණයේ අරය vs විශ්කම්භය:",
          description: "පොයිසල් සමීකරණයේ ඇත්තේ අරයේ 4 වෙනි බලයයි (r^4). බොහෝ ප්‍රශ්න වල ලබා දෙන්නේ නළයේ විශ්කම්භයයි. එය දෙකෙන් බෙදා අරය ලබාගැනීමට අමතක වීමෙන් බහුවරණ වලදී වැරදි පිළිතුරට යොමු වේ."
        }
      ]
    },
    {
