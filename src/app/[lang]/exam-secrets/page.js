...
export default async function ExamSecretsPage({ params }) {
  ...
  const examSecretsDataSi = [
    ...
    },
    {
      ...
      traps: [
        {
          title: "ෆ්‍ලෙමිංගේ නීති මාරු වීම:",
          description: "මෝටර සඳහා (බලය සෙවීමට) ෆ්‍ලෙමිංගේ වම් අත් නියමයද, විද්‍යුත් චුම්බක ප්‍රේරණය සඳහා (ප්‍රේරිත ධාරාව සෙවීමට) දකුණු අත් නියමයද භාවිතා කළ යුතුය. මේ දෙක මාරු කර ගැනීමෙන් සම්පූර්ණ ලකුණු අහිමි වේ."
        }
      ]
    },
    {
